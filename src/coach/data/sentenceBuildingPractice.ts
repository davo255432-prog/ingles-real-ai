...
export const SENTENCE_BUILDING_VERBS: SentenceVocabularyItem[] = [
  ...
  { id: 'go-to', english: 'go to', spanish: 'ir a', pronunciation: 'gou ru' },
];
...
export const GUIDED_CONSTRUCTIONS: GuidedConstruction[] = [
  ...
  },
  {
    ...
    pronunciation: 'ai am at joum. ai am re-di. ai gou ru skul',
...
export const MISSION_SPEAKING_STORIES: MissionStory[] = [
  ...
  },
  {
    ...
    pronunciation: 'ai am at joum. ai am re-di. ai gou ru skul and ai jav kis',
...
export const MISSION_LISTENING_STORIES: MissionStory[] = [
  ...
  },
  {
    ...
    pronunciation: 'dei gou ru skul. dei nid jelp bi-kos dei ar tai-erd',
  ...
  },
  {
    ...
    pronunciation: 'ai am jir. ai jav foun and kis. ai gou ru uerk',
